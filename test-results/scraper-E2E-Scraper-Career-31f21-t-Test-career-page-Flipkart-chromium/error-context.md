...
- Name: scraper.test.ts >> E2E Scraper Career Pages Test >> Test career page: Flipkart
- Location: tests/e2e/scraper.test.ts:23:9

# Error details

```
Error: page.goto: net::ERR_NAME_NOT_RESOLVED at https://careers.flipkart.com/
Call log:
  - navigating to "https://careers.flipkart.com/", waiting until "domcontentloaded"

...
- Name: scraper.test.ts >> E2E Scraper Career Pages Test >> Test career page: Zomato
- Location: tests/e2e/scraper.test.ts:23:9

# Error details

```
Error: page.goto: net::ERR_HTTP2_PROTOCOL_ERROR at https://www.zomato.com/careers
Call log:
  - navigating to "https://www.zomato.com/careers", waiting until "domcontentloaded"
